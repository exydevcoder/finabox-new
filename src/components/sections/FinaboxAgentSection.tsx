      ...
      <div className="container flex flex-col md:flex-row items-start sm:items-center justify-between gap-10">
        <div className="flex flex-col items-start gap-6 max-w-full sm:max-w-[785px]">
          <FadeIn direction="up" delay={0.3} distance={40} duration={0.8}>
            <h1 className="titleStyle max-w-[250px] xs:max-w-[340px] sm:max-w-[500px]">
        ...
        <FadeIn
          ...
          delay={0.2}
          duration={0.8}
          className="pb-0 p-4 max-w-full xs:max-w-[583px] bg-gradient-to-b from-white/5 to-white/0 rounded-2xl l shadow-[inset_0px_1px_0px_1px_rgba(255,255,255,0.03)] backdrop-blur-sm border-t border-l border-r border-indigo-600"
        >
